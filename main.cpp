...
bool except_date(char* string) {
    ...
    int nrok = 0, nran = 0, nrzile, nrluni, i;
    ...
    if (0 < nrluni and nrluni <= 12 and lista_zile[nrluni] >= nrzile and nrzile > 0 and (nran % 4 == 0 or nran % 400 == 0))
        nrok = nrok + 1;

    else
        if (0 < nrluni and nrluni <= 12 and lista_zile[nrluni] > nrzile and nrzile > 0)
            nrok = nrok + 1;
...
int main()
{
    ...
    while (op)
    {
        ...
        if (op == 3)
        {
            ...
            Filme s(nume_sters, date_sters, gen_sters);
            repo.deleteFilme(s);
            cout << endl;
        ...
        if (op == 4)
        {
            ...
            cout << "Dati titlul: ";
            cin >> name;
            cout << "Dati noul titlul: ";
            cin >> name_new;
            cout << "Dati noua data: ";
            cin >> date_new;
            cout << "Dati noul genul: ";
            cin >> gen_new;
